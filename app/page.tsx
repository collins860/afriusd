    ...
    <main className="min-h-screen overflow-hidden" style={{ backgroundColor: "var(--bg-base)", color: "var(--text-primary)" }}>
      ...
      <section className="pt-32 pb-20 px-6 relative">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-2">
            <Link href="/signup">
              <button className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all glow-emerald hover:scale-[1.03]">
                Start Accepting Payments
              </button>
            </Link>
            <Link href="/login">
              <button className="w-full sm:w-auto border px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:border-emerald-500/50 hover:scale-[1.03]"
                style={{ borderColor: "var(--border)", color: "var(--text-secondary)" }}>
                View Dashboard →
              </button>
            </Link>
          </div>
          <p className="text-sm mt-6 animate-fade-in-up delay-3" style={{ color: "var(--text-muted)" }}>No bank account required · Instant settlement · Zero borders</p>
        </div>

        {/* Hero Card Preview */}
        <FadeInSection delay={200} className="max-w-4xl mx-auto mt-20 relative px-4 sm:px-0">
          <div className="glass rounded-2xl p-4 sm:p-6 hover-lift">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-3xl font-bold mt-1">
                  <CountUp end={24850} prefix="$" decimals={2} />
                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                { label: "USDC Received", value: 24850, color: "text-blue-400" },
              ].map((stat) => (
                <div key={stat.label} className="rounded-xl p-4 border flex sm:block items-center justify-between hover-lift" style={{ backgroundColor: "var(--bg-input)", borderColor: "var(--border)" }}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <FadeInSection key={feature.title} delay={i * 80}>
                <div className="glass rounded-xl p-6 hover:border-emerald-500/30 transition-all hover-lift group h-full">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <FadeInSection key={item.step} delay={i * 80}>
                <div className="flex gap-6 p-6 glass rounded-xl hover-lift h-full">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <FadeInSection key={benefit.title} delay={i * 80}>
                <div className="flex gap-4 p-6 glass rounded-xl hover-lift h-full">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <FadeInSection>
            <div className="glass rounded-2xl p-12 relative overflow-hidden hover-lift">
              ...
              <div className="relative z-10">
                ...
                <Link href="/signup">
                  <button className="bg-emerald-500 hover:bg-emerald-400 text-white px-10 py-4 rounded-xl font-semibold text-lg transition-all glow-emerald hover:scale-[1.03]">
                    Launch App →
                  </button>
                </Link>
              </div>
